...
class CatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post cats_url, params: { cat: { name: @cat.name, stamina: @cat.stamina, state: @cat.state } }
    end
  ...
  test "should update cat" do
    patch cat_url(@cat), params: { cat: { name: @cat.name, stamina: @cat.stamina, state: @cat.state } }
